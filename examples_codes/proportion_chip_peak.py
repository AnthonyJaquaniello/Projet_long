...
BIN=10000
NTOT=283188 # total number of bins for human
...
group222['start1'] = group22['start1']-1
...
plt.xlim(-1,2.5)
plt.ylabel('Proportion of bins enriched in Nipbl')
plt.title('Proportion of bins enriched in Nipbl, pvalue~ '+str(pvalue))
...
plt.legend(('Nipbl peak', 'other'), loc=1)
plt.show()
